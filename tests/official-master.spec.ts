...
describe('official Excel product master', () => {
  ...
  it('uses only unit-per-box values that are deterministically resolved from the official cross-check', () => {
  ...
  it('keeps unresolved case packs explicitly in standby instead of inferring them', () => {
